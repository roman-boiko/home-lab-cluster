...
Key rule: Ansible is only for OS preparation, initial k3s installation, first Cilium bootstrap, kubeconfig download, and the Argo CD seed. After Argo CD is installed, all application and infrastructure changes must be made through Git and reconciled by Argo CD.
